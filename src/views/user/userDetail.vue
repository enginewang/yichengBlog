    ...
    <el-card class="box-card">
      <el-row :gutter="24" style="margin-top: 2em">
        <el-col :span="8" :offset="1">
          ...
          <h4 style="margin-top: 3em"> 上传新头像 </h4>
          <el-upload
                  class="upload-box"
                  drag
          ...
          <div v-show="hasUpload">
            <div class="img-box" style="margin-top: 2em;">
              ...
              <p>图片URL: {{ newAvatarUrl }}</p>
            </div>
            <el-button @click="modifyAvatar">确定修改</el-button>
          </div>
        </el-col>
          ...
          <el-card class="box-card" shadow="never" style="border:none">
            <el-row :gutter="10" style="margin-bottom: 2em;">
              ...
              <el-col :span="4" :offset="4">
                <svg t="1584404503153" class="icon" viewBox="0 0 1024 1024" version="1.1"
                     style="margin-top:-0.3em;width: 1.8rem;height:1.8rem;position: relative;margin: 0;padding-bottom: .5em;"
            ...
            <el-row :gutter="10" style="margin-bottom: 2em;">
              ...
              <el-col :span="6" style="font-family: 'FZZhengHeiS-M-GB'; float: left;font-size: 1.2rem;">{{roleName}}
              </el-col>
            </el-row>
