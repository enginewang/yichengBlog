    ...
    <div>
        ...
        <common-layout>
            <template v-slot:main>
                ...
                <div class="content">
                    <div v-for="(article, id) in articleList" v-bind:key="id" class="articleCard"
                         v-show="judgeShow(article)" @click="seeDetail(article._id)">
                        <img :src="article.cover" alt="article.cover" class="articleCover">
                        ...
                        <p class="articleTime"><i class="el-icon-time"></i> {{ timeStampToString(article.pubTime) }}</p>
                    </div>
