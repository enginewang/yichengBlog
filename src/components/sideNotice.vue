<template>
  <div class="side-notice">
    ...
    <el-card class="box-card" style="margin-top: 2em;" shadow="hover">
      ...
      <div class="latestArticle" v-for="(lastestArticle, id) in LatestArticleList" :key="id"
           style="padding-left: 1em;margin: 0;text-align: left">
        <el-button type="text" @click="toArticleDetail(lastestArticle._id)"
                   style="padding-top: 4px;padding-bottom: 4px;">{{ lastestArticle.title }}
          <!--                    <label style="font-size: x-small;color: black">{{ timeStampToString(lastestArticle.pubTime,-->
          <!--                        "day").slice(2,) }}</label>-->
        </el-button>
      </div>
    </el-card>
    <el-card class="box-card" style="margin-top: 2em;" shadow="hover">
      ...
      <el-button @click="goToKindQuery(kind.articleKind)" v-for="(kind, i) in articleKindList" :key="i"
                 type="text" style="margin-top: 0em;margin-bottom: 0em;padding: .5em 0em">
    ...
    <el-card class="box-card" style="margin-top: 2em;margin-bottom: 2em;" shadow="hover">
      ...
      <el-button @click="goToTagQuery(tag.articleTag)" v-for="(tag, i) in articleTagList" :key="i" type="text"
                 style="margin-top: 0em;margin-bottom: 0em;padding: .5em 0em">
